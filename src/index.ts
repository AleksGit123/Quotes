...
let articleDiv = document.querySelector(".section2__article__div") as HTMLDivElement;
// add new quote window
let addQuoteDiv = document.querySelector(".new__quote__div") as HTMLDivElement;
let newQuote = document.querySelector(".new__quote") as HTMLButtonElement; 
let addQuote = document.querySelector(".add__quote") as HTMLButtonElement;
let neverMindBtn = document.querySelector(".cancel") as HTMLButtonElement;

let author = document.querySelector(".author__input") as HTMLInputElement;
let quote = document.querySelector(".quote__textarea") as HTMLInputElement;
...
let addNewQuote = (author:string, quote:string) =>{
